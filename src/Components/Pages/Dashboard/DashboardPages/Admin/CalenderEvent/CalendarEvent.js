...
const defaultEvents = [
  ...
  {
    id: 2,
    start: "2023-07-28T15:00",
    end: "2023-07-28T16:00",
  ...
  {
    id: 3,
    start: "2023-07-27T18:00",
    end: "2023-07-27T22:00",
    title: "Dexter BD",
    description: "",
    allDay: false,
    free: true,
  ...
  {
    id: 4,
    start: "2023-07-29T10:30",
    end: "2023-07-29T11:30",
...
function CalendarEvent() {
  ...
  return (
    <div>
        <h2 className="text-2xl p-5">Event Calendar</h2>
      <div className="px-10 my-20 rounded-md">
        <Eventcalendar
          view={viewSettings}
          data={myEvents}
